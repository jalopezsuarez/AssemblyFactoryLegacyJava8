/*
 * gearman-client 0.8.11-SNAPSHOT
 */
...
public class NetworkGearmanClient extends AbstractGearmanClient {
    ...
    public String submitJobInBackground(String callback, byte[] data, JobPriority priority) throws NoServersAvailableException {
        return submitJobInBackground(callback, data, priority, UUID.randomUUID().toString());
    }

    public String submitJobInBackground(String callback, byte[] data, JobPriority priority, String jobid) throws NoServersAvailableException
    {
